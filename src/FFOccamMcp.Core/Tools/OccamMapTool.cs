...
public sealed class OccamMapTool(MapService mapService)
{
    ...
    public async Task<string> Map(
        [Description("HTTP(S) seed URL or search handle (S1 / H…).")] string url,
        ...
        [Description("Focus keywords: entity-first re-rank; homepage may expand one hub level.")] string? focus_query = null,
