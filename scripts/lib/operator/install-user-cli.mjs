...
export const RELEASE_RUNTIME_FILES = Object.freeze([
  ...
  "scripts/occam-install-workers.mjs",
  "scripts/lib/ensure-workers-deps.mjs",
  ...
  "scripts/occam-data.mjs",
  "scripts/occam-read.mjs",
  "scripts/occam-search.mjs",
  "scripts/occam-digest.mjs",
  "scripts/occam-pack.mjs",
  "scripts/occam-research.mjs",
  "scripts/occam-brief.mjs",
  "scripts/occam-cite.mjs",
  "scripts/lib/operator/occam-data-cli.mjs",
  "scripts/lib/operator/occam-pack.mjs",
  "scripts/lib/operator/occam-pack-cli.mjs",
  "scripts/lib/operator/occam-research.mjs",
  "scripts/lib/operator/occam-research-cli.mjs",
  "scripts/lib/operator/occam-brief.mjs",
  "scripts/lib/operator/occam-brief-cli.mjs",
  "scripts/lib/operator/occam-cite.mjs",
  "scripts/lib/operator/occam-cite-cli.mjs",
  "scripts/lib/operator/discovery-rank.mjs",
  ...
  "scripts/lib/operator/update-apply.mjs",
