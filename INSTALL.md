...
**Published release:** `1.3.0` (GitHub Release tag `v1.3.0`).
**Public install default** (unset `OCCAM_VERSION`): **`1.3.0`**.
...
**Public default** (unset `OCCAM_VERSION`): **`1.3.0`**. Set `OCCAM_VERSION=1.2.0`, `1.1.0`, `1.0.0`, `1.0.0-rc.5`, `1.0.0-rc.4`, `1.0.0-rc.3`, or `1.0.0-rc.2` only when you intentionally need an older channel.
...
| `OCCAM_VERSION` | `1.3.0` (public default; published GitHub Release) | Release version; set an older tag only for a legacy channel |
