...
**Published release:** `1.0.0-rc.4` (GitHub Release tag `v1.0.0-rc.4`).
**Public install default** (unset `OCCAM_VERSION`): **`1.0.0-rc.4`**.
...
**Public default** (unset `OCCAM_VERSION`): **`1.0.0-rc.4`**. Set `OCCAM_VERSION=1.0.0-rc.3` or `1.0.0-rc.2` only when you intentionally need an older channel.
...
| `OCCAM_VERSION` | `1.0.0-rc.4` (public default; published GitHub Release) | Release version; set an older tag only for a legacy channel |
