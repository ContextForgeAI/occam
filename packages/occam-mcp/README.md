...
npx ff-occam@1.1.0 --mcp-server
npx ff-occam@1.1.0 --mcp-server --port 5051
```
...
| **npm / npx RC** | `npx ff-occam@1.1.0` from registry | Primary wrapper delegates to `@ff-occam/mcp` and downloads the matching release binary |
